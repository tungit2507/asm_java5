    ...
    <div class="main-w3layouts wrapper"></div>
        ...
        <div class="main-agileinfo">
            <div class="agileits-top">
                <form action="signUp" method="post" enctype="multipart/form-data" modelAttr>
                   	<p>${message}</p>                    
                    <input class="text" type="text" name="username" placeholder="Username" required="required">
                    <input class="text email" type="text" name="fullname" placeholder="Fullname" required="required">
                    <input class="text email" type="email" name="email" placeholder="Email" required="required">
                    <input class="text email" type="text" name="phone_number" placeholder="Phone Number" required="required">	 
                    <input class="text email" type="text" name="adress" placeholder="Adress" required="required">	  
                    <input class="text" type="password" name="password" placeholder="Password" required="required">
                    <input class="text w3lpass" type="password" name="cpassword" placeholder="Confirm Password"
                        required="required">

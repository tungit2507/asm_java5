        ...
        <div class="main-agileinfo">
            <div class="agileits-top">
                <form action="login" method="post">
                    ...
                    <input class="text email" type="password" name="password" placeholder="Enter Your password" required="required">
                    <p>${message}</p>
                    <a href="<c:url value='forgotPass'/>"> <p>Forgot password? </p></a>
                    <input type="submit">
                </form>
